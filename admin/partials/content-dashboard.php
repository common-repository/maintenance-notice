...
<div id="cvmn-dashboard">
    <h2 class="cvmn-admin-title">
        <?php esc_html_e( 'Get Started with Maintenance Notice', 'maintenance-notice' ); ?>
    </h2><!-- .cvmn-admin-title -->
    <div class="cvmn-admin-desc">
        <?php esc_html_e( 'Maintenance Notice is the plugin for all site', 'maintenance-notice' ); ?>
                    ...
                    <form id="cvmn-maintenance-notice-options-form" method="POST">
                        ...
                        <div class="cvmn-admin-field-options-wrapper">
                            ...
                            <div class="cvmn-admin-single-field cvmn-preview-button">
                                ...
                                <a href="<?php echo esc_url( home_url( '/?cvmn-maintenance-preview' ) ); ?>" target="_blank"><?php esc_html_e( 'Preview', 'maintenance-notice' ); ?></a>
                            </div>
                            <div class="cvmn-form-button-wrapper">
                                ...
                                <div class="cvmn-form-button">
                                    <input type="submit" name="cvmn_reset" class="button button-primary" value="<?php esc_attr_e( 'Reset settings', 'maintenance-notice' ); ?>">
                                </div>
