...
if ( isset( $_POST['cvmn_submit'] ) ) {
    // Check the nonce
    if ( ! isset( $_POST['cvmn_nonce_field'] ) || ! wp_verify_nonce( $_POST['cvmn_nonce_field'], 'cvmn_nonce_action' ) ) {
...
<div id="cvmn-background-settings" class="cvmn-content-block-wrapper">
    <div class="cvmn-admin-content">
        <form id="cvmn-maintenance-notice-options-form" method="POST">
            <?php wp_nonce_field( 'cvmn_nonce_action', 'cvmn_nonce_field' ); ?>
            <div class="cvmn-admin-field-options-wrapper">
               ...
               <div class="cvmn-admin-single-field" data-control="cvmn_maintenance_page_background_type" data-value="plain-color" <?php if ( $cvmn_maintenance_page_background_type !== 'plain-color' ) echo 'style="display:none"'; ?>>
                ...
                <div class="cvmn-admin-single-field cvmn-radio-image-field">
                    ...
                    <span class="image-selector <?php if ( $cvmn_background_overlay_type === 'none' ) echo 'isActive'; ?>" data-value="none"><img src="<?php echo esc_url( MAINTENANCE_NOTICE_ADMIN_URL . '/assets/images/background-overlay-none.png' ); ?>" alt=""/></span>
                    <span class="image-selector <?php if ( $cvmn_background_overlay_type === 'type-one' ) echo 'isActive'; ?>" data-value="type-one"><img src="<?php echo esc_url( MAINTENANCE_NOTICE_ADMIN_URL . '/assets/images/background-overlay-one.png' ); ?>" alt=""/></span>
                    <span class="image-selector <?php if ( $cvmn_background_overlay_type === 'type-two' ) echo 'isActive'; ?>" data-value="type-two"><img src="<?php echo esc_url( MAINTENANCE_NOTICE_ADMIN_URL . '/assets/images/background-overlay-two.png' ); ?>" alt=""/></span>
                    <span class="image-selector <?php if ( $cvmn_background_overlay_type === 'type-three' ) echo 'isActive'; ?>" data-value="type-three"><img src="<?php echo esc_url( MAINTENANCE_NOTICE_ADMIN_URL . '/assets/images/background-overlay-three.png' ); ?>" alt=""/></span>
                    <span class="image-selector <?php if ( $cvmn_background_overlay_type === 'type-four' ) echo 'isActive'; ?>" data-value="type-four"><img src="<?php echo esc_url( MAINTENANCE_NOTICE_ADMIN_URL . '/assets/images/background-overlay-four.png' ); ?>" alt=""/></span>
                ...
                <div class="cvmn-form-button-wrapper">
                    <div class="cvmn-form-button">
                        <input type="submit" name="cvmn_submit" class="button button-primary" data-saving="<?php esc_attr_e( 'Saving..', 'maintenance-notice' ); ?>" data-saved="<?php esc_attr_e( 'Saved', 'maintenance-notice' ); ?>" data-save="<?php esc_attr_e( 'Save Changes', 'maintenance-notice' ); ?>" value="<?php esc_attr_e( 'Saved', 'maintenance-notice' ); ?>" disabled="disabled">
                    </div>
                </div>
